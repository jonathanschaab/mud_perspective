...
mod tests {
    ...
    fn test_empty_tag_parts_return_errors() {
        let err1 =
            Template::compile("The {a:} approaches.").expect_err("Expected compilation to fail");
        ...
        let err4 = Template::compile("The goblin hits {source:}.")
            .expect_err("Expected compilation to fail");
        ...
        let err7 =
            Template::compile("You [source:be|].").expect_err("Expected compilation to fail");
        assert_eq!(
            err7,
        ...
        let err11 = Template::compile("You [source:be|am|are|is;].")
            .expect_err("Expected compilation to fail");
        assert_eq!(
            err11,
        ...
        let err12 = Template::compile("You [source:be|;was||was].")
            .expect_err("Expected compilation to fail");
        assert_eq!(
            err12,
    ...
    fn test_extended_forced_conjugation() {
        ...
        assert_eq!(
            render_msg!("char_2", &template_2, "source" => &player)
                .expect("Failed to render template"),
            "Aldran freaks out."
        );
        assert_eq!(
            render_msg!("char_2", &template_2, "source" => &wolves)
                .expect("Failed to render template"),
    ...
    fn test_dot_notation_resolution() {
        ...
        let out_actor = render_msg!("char_1", &template, "source" => &player)
            .expect("Failed to render template");
        assert_eq!(
            out_actor,
    ...
    fn test_actor_stances() {
        ...
        let out_second = render_msg!("char_1", &template, "source" => &player)
            .expect("Failed to render template");
    ...
    fn test_first_person_conjugation_and_pronouns() {
        ...
        assert_eq!(
            PerspectiveEngine::render(&template_past, &ctx_past)
                .expect("Failed to render template"),
    ...
    fn test_all_pronoun_cases_with_stances() {
        ...
        let ctx_first_plural = RenderContext::new("char_1")
            ...
            .with_entity("target", &goblin);
        assert_eq!(
            PerspectiveEngine::render(&template, &ctx_first_plural)
                .expect("Failed to render template"),
    ...
    fn test_plural_viewer_first_person_stance() {
        ...
        assert_eq!(
            PerspectiveEngine::render(&group_template, &group_ctx)
                .expect("Failed to render template"),
        ...
        assert_eq!(
            PerspectiveEngine::render(&obj_template, &obj_ctx_solo)
                .expect("Failed to render template"),
    ...
    fn test_group_entity_possessives() {
        ...
        assert_eq!(
            PerspectiveEngine::render(&template, &ctx_solo_second)
                .expect("Failed to render template"),
            "You take your gold."
        );
        ...
        assert_eq!(
            PerspectiveEngine::render(&template, &ctx_solo_first)
                .expect("Failed to render template"),
            "You take my gold."
        );
        ...
        assert_eq!(
            PerspectiveEngine::render(&template, &ctx_first_big)
                .expect("Failed to render template"),
        ...
        assert_eq!(
            PerspectiveEngine::render(&template, &ctx_second_big)
                .expect("Failed to render template"),
    ...
    fn test_past_tense_have_across_stances() {
        ...
        assert_eq!(
            PerspectiveEngine::render(&template_have, &ctx_second)
                .expect("Failed to render template"),
            "You have a sword."
        );
        assert_eq!(
            PerspectiveEngine::render(&template_have, &ctx_third)
                .expect("Failed to render template"),
            "Aldran has a sword."
        );
    ...
    fn test_phrasal_verbs() {
        ...
        let template_cap = cache
            ...
            .expect("Failed to compile template");
        assert_eq!(
            PerspectiveEngine::render(&template_cap, &ctx_third)
                .expect("Failed to render template"),
            "Gives up!"
        );
    }
    ...
    fn test_dynamic_past_tense_with_groups() {
        ...
        assert_eq!(
            PerspectiveEngine::render(&template, &ctx_solo_actor)
                .expect("Failed to render template"),
        ...
        assert_eq!(
            PerspectiveEngine::render(&template, &ctx_party_actor)
                .expect("Failed to render template"),
    ...
    fn test_dynamic_past_tense_forced_conjugation() {
        ...
        assert_eq!(
            PerspectiveEngine::render(&t_both, &ctx_director_past)
                .expect("Failed to render template"),
            "Aldran was here."
        );
    ...
    fn test_all_twelve_english_tenses() {
        ...
        assert_eq!(
            PerspectiveEngine::render(&t_continuous, &ctx_future)
                .expect("Failed to render template"),
    ...
    fn test_manual_sentence_boundaries() {
        ...
        let t_no_sb = cache
            ...
            .expect("Failed to compile template");
        let out_no_sb =
            PerspectiveEngine::render(&t_no_sb, &ctx).expect("Failed to render template");
    ...
    fn test_singular_override_tenses_and_stances() {
        ...
        assert_eq!(
            PerspectiveEngine::render(&template, &ctx_director_fut)
                .expect("Failed to render template"),
