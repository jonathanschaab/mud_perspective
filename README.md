...
* **Memory Efficiency:** Using a lock-free AST cache backed by an LRU eviction strategy and Cow (Clone-on-Write) strings to minimize heap allocations during high-frequency combat loops.
